 ...
 *
 */
public class Node3 extends JFrame
{
			 ...
			 while(true)
				{
						...
						//System.out.println(way);
						 ...
						 if(dest.equalsIgnoreCase("Node3"))
					      {
							 	//stmt.executeUpdate("truncate table path");
	...
	private void initializeComponent()
	{
		...
		String st[]={"Select","Node1","Node2","Node4","Node5"};
		...
		jTabbedPane1.addTab("Node3", jPanel1);
	...
	//	
		...
		// Node1
		//
		this.setTitle("Node3 - extends JFrame");
		...
		try
			{
				...
				String path="path:Node3";
				time=System.nanoTime();;
				Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
					  Connection con=DriverManager.getConnection("jdbc:odbc:path","sa","");
					  Statement stmt=con.createStatement();
					  stmt.executeUpdate("truncate table path");
				if(destination.equalsIgnoreCase("Node3"))	
						{
